...
mod tests {
    use super::*;
    use crate::core::{ArgminFloat, Executor, IterState, Problem, PseudoProblem, Solver, KV};
    ...
    fn test_store() {
        ...
        let mut exec: Executor<PseudoProblem, PhonySolver, _> = Executor::new(problem, solver)
            .configure(
