...
impl CostFunction for RosenbrockNG {
...
impl Gradient for RosenbrockNG {
    type Param = DVector<f64>;
...
fn criterion_benchmark(c: &mut Criterion) {
    ...
    group.bench_function("LBFGS_Vec", |bencher| {
        bencher.iter(|| {
            run_vec(
                black_box(a),
                black_box(b),
    ...
    group.bench_function("LBFGS_ngalgebra", |bencher| {
        bencher.iter(|| {
            run_ngalgebra(
                black_box(a),
                black_box(b),
    ...
    group.bench_function("LBFGS_ndarray", |bencher| {
        bencher.iter(|| {
            run_ndarray(
                black_box(a),
                black_box(b),
